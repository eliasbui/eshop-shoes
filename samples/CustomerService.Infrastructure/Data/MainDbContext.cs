...
public class MainDbContext : AppDbContextBase, IDbFacadeResolver
{
    ...
    {
        modelBuilder.HasPostgresExtension(ConstPostgresql.UuidGenerator);
        ...
        modelBuilder.Entity<Customer>().Property(x => x.Id).HasColumnType("uuid")
            .HasDefaultValueSql(ConstPostgresql.UuidAlgorithm);

        modelBuilder.Entity<Customer>().Property(x => x.CountryId).HasColumnType("uuid");
        modelBuilder.Entity<Customer>().Property(x => x.Created).HasDefaultValueSql(ConstPostgresql.DateAlgorithm);
        ...
        modelBuilder.Entity<CreditCard>().Property(x => x.Created).HasDefaultValueSql(ConstPostgresql.DateAlgorithm);
